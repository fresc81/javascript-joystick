...
/**
 * Reads the controller's main stick z-axis.
 * 
 * @return a value between 0 and 65535 (with 0 being extreme top and 65535 extreme bottom)
 */
Joystick.prototype.getZ = function() {
	return (this.ctl) ? this.ctl.z : Joystick.CENTER;
};

/**
 * Reads the controller's main stick r-axis.
 * 
 * @return a value between 0 and 65535 (with 0 being extreme top and 65535 extreme bottom)
 */
Joystick.prototype.getR = function() {
	return (this.ctl) ? this.ctl.r : Joystick.CENTER;
};

/**
 * Reads the controller's main stick u-axis.
 * 
 * @return a value between 0 and 65535 (with 0 being extreme top and 65535 extreme bottom)
 */
Joystick.prototype.getU = function() {
	return (this.ctl) ? this.ctl.u : Joystick.CENTER;
};

/**
 * Reads the controller's main stick v-axis.
 * 
 * @return a value between 0 and 65535 (with 0 being extreme top and 65535 extreme bottom)
 */
Joystick.prototype.getV = function() {
	return (this.ctl) ? this.ctl.v : Joystick.CENTER;
};

/**
 * Returns the controller's POV direction when pressed.
 * 
 * @return Hat-switch, in degrees multiplied by 100
 */
Joystick.prototype.getPOV = function() {
	return (this.ctl) ? this.ctl.pov : 65535;
};
 ...
 * Reads the state of all the controller's non-directional buttons.
 * 
 * @param buttons the buttons represented as bits in an integer
 * @return true if all of the specified buttons are pressed
 */
Joystick.prototype.getButtonsAnd = function(buttons) {
	return (this.ctl) ? (this.ctl.buttons & buttons) == buttons : false;
};

/**
 * Reads the state of all the controller's non-directional buttons.
 * 
 * @param button the buttons represented as bits in an integer
 * @return true if one of the specified buttons are pressed
 */
Joystick.prototype.getButtonsOr = function(buttons) {
	return (this.ctl) ? (this.ctl.buttons & buttons) != 0 : false;
};
